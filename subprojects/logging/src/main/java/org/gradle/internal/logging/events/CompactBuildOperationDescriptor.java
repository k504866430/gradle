...
public class CompactBuildOperationDescriptor implements Serializable {
    ...
    public CompactBuildOperationDescriptor(Object operationId, BuildOperationType operationType) {
        Preconditions.checkNotNull(operationId, "Cannot construct build operation descriptor with null id");
        Preconditions.checkNotNull(operationType, "Cannot construct build operation descriptor with null operation type");
